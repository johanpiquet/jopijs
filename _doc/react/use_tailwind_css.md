...
This file is automatically generated by Jopi, by concatening intelligently all the `global.css` files found.

```
|- package.json
|- global.compiled.css      < Build by Jopi
|- global.css               < Take this one if found
|- src/
    |- global.css           < Concat with this one
    |- mod_module1/
        |- global.css       < Concat with this one
    |- mod_module2/
        |- global.css       < Concat with this one
